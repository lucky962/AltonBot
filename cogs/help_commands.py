...
class HelpCommands:
    ...
    async def do_help(self, ctx):
        if ctx.invoked_subcommand is None:
            ...
            HelpMsg.set_author(name='Alton Bot', icon_url=self.bot.user.avatar_url)
            ...
            HelpMsg.set_footer(icon_url=self.bot.user.avatar_url, text='© Alton County Railways')
            await ctx.send(embed=HelpMsg)

    @do_help.command(name='moderation')
